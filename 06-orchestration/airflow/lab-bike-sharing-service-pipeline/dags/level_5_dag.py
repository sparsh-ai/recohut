...
# Stations
station_source_object = f"lab-4/stations/stations.csv"
...
# Regions
gcs_regions_source_object = "data/regions/regions.csv"
gcs_regions_target_object = f"lab-4/regions/{extracted_date_nodash}/regions.csv"
...
gcs_trips_source_object = f"lab-4/trips/{extracted_date_nodash}/*.csv"
...
with DAG(
    ...
    gcs_to_bq_trips = GoogleCloudStorageToBigQueryOperator(
        ...
        time_partitioning={
            'time_partitioning_type': 'DAY', 'field': 'start_date'},
        write_disposition='WRITE_TRUNCATE'
    )
    ...
    dwh_fact_trips_daily = BigQueryOperator(
        ...
        write_disposition='WRITE_TRUNCATE',
        time_partitioning={
            'time_partitioning_type': 'DAY', 'field': 'trip_date'},
        create_disposition='CREATE_IF_NEEDED',
        use_legacy_sql=False,
        priority='BATCH'
    )
    ...
    send_dag_success_signal = GoogleCloudStorageToGoogleCloudStorageOperator(
        ...
        source_bucket=gcs_source_data_bucket,
        source_object=f'lab-4/data/signal/_SUCCESS',
        destination_bucket=gcs_source_data_bucket,
        destination_object=f'lab-4/data/signal/staging/level_5_dag_sensor/{extracted_date_nodash}/_SUCCESS'
    )
    ...
    [bq_row_count_check_dwh_fact_trips_daily,
        bq_row_count_check_dwh_dim_stations] >> send_dag_success_signal
