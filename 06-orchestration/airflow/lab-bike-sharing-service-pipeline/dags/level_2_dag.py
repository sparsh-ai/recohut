...
GCP_PROJECT_ID = 'sparsh-data-eng-on-gcp'
INSTANCE_NAME = 'mysql-instance'
EXPORT_URI = 'gs://sparsh-data-eng-on-gcp-data-bucket/mysql_export/from_composer/stations/stations.csv'
...
with DAG(
    ...
    gcs_to_bq_example = GoogleCloudStorageToBigQueryOperator(
        ...
        bucket='sparsh-data-eng-on-gcp-data-bucket',
