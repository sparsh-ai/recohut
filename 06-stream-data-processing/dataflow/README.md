...
1. [Lab: Build a simple Dataflow Pipeline (Python)](./lab-gcp-dataflow-pipeline.md)
1. [Lab: Batch Analytics Pipelines with Cloud Dataflow (Python)](./lab-gcp-dataflow-batch-pipeline.md)
