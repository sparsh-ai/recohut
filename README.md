...
- Getting Started
  ...
  - Data Engineering
    ...
    - [SQL vs NoSQL](01-foundations/basics/sql-vs-nosql.md)
    - [Big Data](01-foundations/basics/big-data.md)
    - [Batch vs Incremental Data Processing](01-foundations/basics/batch-vs-incremental.md)
    - [Data Contract](01-foundations/basics/data-contract.md)
    - [Data Governance](01-foundations/basics/data-governance.md)
    - [Data Management](01-foundations/basics/data-management.md)
    - [Data Quality](01-foundations/basics/data-quality.md)
    - [Batch Data Processing](01-foundations/basics/batch-data-processing.md)
    - [Stream and Unified Data Processing](01-foundations/basics/stream-data-processing.md)
  ...
  - Spark and Hadoop
    - [Apache Spark Basics](01-foundations/basics/spark-basics.md)
    - [Origin of Spark](01-foundations/basics/spark-origin.md)
    - [Hadoop Basics](01-foundations/basics/hadoop-basics.md)
    - [Map Reduce](01-foundations/basics/map-reduce.md)
    - [Hadoop vs Spark](01-foundations/basics/hadoop-vs-spark.md)
    - [Interpreting a Spark DAG](01-foundations/basics/spark-dag.md)
    - [Spark RDDs](01-foundations/basics/rdd.md)
    - [Quiz: Spark basics](a1-interviewprep/spark-quiz.md)

  - Developer Essentials
    - [Install Anaconda](01-foundations/developer/install-anaconda.md)
    - [Install Jupyter Notebook](01-foundations/developer/install-jupyter.md)
    - [Install VS Code](01-foundations/developer/install-vscode.md)
    - [Lab: Explore VS Code features](01-foundations/developer/lab-explore-vscode-features.md)
    - [Setup Git](01-foundations/developer/setup-git.md)
    - [Lab: Learn git commands](01-foundations/developer/lab-learn-git-commands.md)
    - [Lab: Learn bash commands](01-foundations/developer/lab-bash-commands/)
    - [Install DBeaver](01-foundations/developer/install-dbeaver.md)

- Cloud

  - Cloud Computing
    - [Cloud Computing Getting Started Guide](01-foundations/cloud/cloud-basics.md)
    - [Comparison of Cloud Services](01-foundations/cloud/cloud-comparison.md)

  - Amazon Web Services (AWS)
    - [AWS EC2](01-foundations/cloud/ec2.md)
    - [AWS IAM](01-foundations/cloud/iam.md)
    - [AWS Glue](01-foundations/cloud/glue.md)
    - [AWS RDS](01-foundations/cloud/rds.md)
    - [AWS S3](01-foundations/cloud/s3.md)
    - [AWS DMS](01-foundations/cloud/dms.md)
    - [AWS Secrets Manager](01-foundations/cloud/secrets-manager.md)
    - [AWS Container Services](01-foundations/cloud/aws-containers.md)
    - [AWS Commands](01-foundations/cloud/aws-commands.md)
    - [Lab: AWS Account Setup](01-foundations/cloud/lab-aws-setup/)
    - [Lab: AWS IAM Service](01-foundations/cloud/lab-create-iam-policy-role/)
    - [Lab: AWS Secrets Manager Service](01-foundations/cloud/lab-aws-secrets-manager/)
    - [Lab: Create AWS VPC](01-foundations/cloud/lab-create-your-first-vpc/)
    - [Lab: Create AWS EC2 instance](01-foundations/cloud/lab-create-your-first-ec2-instance-linux/)

  - Google Cloud Platform (GCP)
    - [GCP Basics](01-foundations/cloud/gcp-basics.md)
    - [GCP Setup](01-foundations/cloud/gcp-setup.md)

  - Azure Cloud
    - [Azure Basics](01-foundations/cloud/azure-basics.md)
    - [Azure Data Ingestion](01-foundations/cloud/azure-data-ingestion.md)
    - [Azure Batch Processing](01-foundations/cloud/azure-data-ingestion.md)
    - [Azure Full-stack Solutions](01-foundations/cloud/azure-fullstack-solutions.md)

- Programming

  - SQL
    - [SQL Basics](01-foundations/language/sql/sql-basics.md)
    - [SQL Query](01-foundations/language/sql/sql-query.md)
    - [SELECT](01-foundations/language/sql/select.md)
    - [LIMIT](01-foundations/language/sql/limit.md)
    - [WHERE](01-foundations/language/sql/where.md)
    - [LIKE](01-foundations/language/sql/like.md)
    - [IN](01-foundations/language/sql/in.md)
    - [BETWEEN](01-foundations/language/sql/between.md)
    - [IS NULL](01-foundations/language/sql/isnull.md)
    - [AND](01-foundations/language/sql/and.md)
    - [OR](01-foundations/language/sql/or.md)
    - [NOT](01-foundations/language/sql/not.md)
    - [LIKE](01-foundations/language/sql/like.md)
    - [LIKE](01-foundations/language/sql/like.md)
    - [ORDER BY](01-foundations/language/sql/orderby.md)
    - [GROUP BY](01-foundations/language/sql/groupby.md)
    - [HAVING](01-foundations/language/sql/having.md)
    - [CASE](01-foundations/language/sql/case.md)
    - [DISTINCT](01-foundations/language/sql/distinct.md)
    - [CTE (Common Table Expressions)](01-foundations/language/sql/cte.md)
    - [UNION](01-foundations/language/sql/union.md)
    - [Subquery](01-foundations/language/sql/subquery.md)
    - [Views](01-foundations/language/sql/views.md)
    - [Stored Procedures](01-foundations/language/sql/stored-procedures.md)
    - [Triggers](01-foundations/language/sql/triggers.md)
    - [Indexes](01-foundations/language/sql/indexes.md)
    - [Comparison Operators](01-foundations/language/sql/comparison-operators.md)
    - [Logical Operators](01-foundations/language/sql/logical-operators.md)
    - [Joins](01-foundations/language/sql/joins.md)
    - [Comments](01-foundations/language/sql/comments.md)
    - [Cursor](01-foundations/language/sql/cursor.md)
    - [Aggregate Functions](01-foundations/language/sql/aggregate-functions.md)
    - [String Functions](01-foundations/language/sql/string-functions.md)
    - [Date Functions](01-foundations/language/sql/date-functions.md)
    - [Window Functions](01-foundations/language/sql/window-functions.md)
    - [Performance Tuning](01-foundations/language/sql/performance-tuning.md)
    - [SQL Interview Questions](01-foundations/language/sql/sql-interviews-questions.md)
    - [Lab: Ingest data from CSV file into MySQL database table](01-foundations/language/sql/lab-mysql-data-ingestion/)
    - [Lab: SQL Basics to Advanced Primer](01-foundations/language/sql/lab-basic-to-advanced/)
    - [Lab: Postgres SQL basics to advanced](01-foundations/language/sql/lab-postgres-queries/)
    - [Lab: Running Dates, String and Advanced queries in Postgres on Sales data](01-foundations/language/sql/lab-postgres-sales/)
    - [Lab: Working with Book dataset on SQLite database](01-foundations/language/sql/lab-sqlite-basics/)
    - [Challenge - Yammer Advanced Analytics](01-foundations/language/sql/challenges/yammer/)
    - [Challenge - BrainTree SQL Code Challenge](01-foundations/language/sql/challenges/braintree/)
    - [Challenge - Employee Analytics](01-foundations/language/sql/challenges/employee.md)
    - [Challenge - Danny's Diner](01-foundations/language/sql/challenges/assignment5/)
    - [Explore Further](01-foundations/language/sql/links.md)
    
  - Python
    - [Introduction to Python](01-foundations/language/python/introduction-to-python.md)
    - [Lab: Sweet Python Syntax Sugar for Improving Your Coding Experience by Yang Zhou](01-foundations/language/python/python-syntax-sugars.md)
    ...
    - [Lab: ETL process and reading/writing CSV, JSON and XML files in pandas](01-foundations/language/python/lab-etl-csv-json-xml/)
    - [Lab: Exchange Rate ETL process](01-foundations/language/python/lab-exchange-rate-etl/)
    ...
    - [Explore Further](01-foundations/language/python/links.md)

  - PySpark
    - [Installing Spark](01-foundations/language/pyspark/install.md)
    - [PySpark DataFrame](01-foundations/language/pyspark/dataframe.md)
    - [Methods, Operations and Functions](01-foundations/language/pyspark/methods-operations.md)
    - [Partitioning](01-foundations/language/pyspark/partitioning.md)
    - [Lazy Processing](01-foundations/language/pyspark/lazy-processing.md)
    - [Caching](01-foundations/language/pyspark/caching.md)
    - [UDFs](01-foundations/language/pyspark/udf.md)
    - [Broadcasting](01-foundations/language/pyspark/broadcasting.md)
    - [PySpark Cheat Sheet](01-foundations/language/pyspark/cheat-sheet.md)
    - [Spark Execution Plan](01-foundations/language/pyspark/execution-plan.md)
    - [PySpark vs Pandas](01-foundations/language/pyspark/pyspark-vs-pandas.md)
    - Lab: Create your first databricks cluster
    - Lab: Create your first databricks notebook
    - [Lab: PySpark Basics](01-foundations/language/pyspark/lab-pyspark-basics/)
    - Lab: M&M color balls analysis with PySpark
    - [Lab: Candy Sales analysis with PySpark](01-foundations/language/pyspark/lab-wonka-candy-sales)
    ...
    - [Lab: Spark Optimizations](01-foundations/language/pyspark/lab-spark-optimizations/)
    - [Lab: Spark Optimization II](01-foundations/language/pyspark/lab-spark-optimizations-2/)
    - [Lab: Uber Analysis](01-foundations/language/pyspark/lab-uber-analysis/)
    - [Lab: Understand Spark Query Execution](01-foundations/language/pyspark/lab-understand-spark-query-execution/)
    - [Lab: Window Functions](01-foundations/language/pyspark/lab-window-functions/)
    - [Lab: BCG Case Study](01-foundations/language/pyspark/lab-bcg/)
  ...
  - Scala
    - [Lab: Getting Started with Scala](01-foundations/language/scala/lab-scala-getting-started/)
...
- Data Science & Machine Learning
  ...
  - Basics
    - [The data science origin story](01-foundations/basics/origin.md)
    - [Use Cases](01-foundations/basics/use-cases.md)
    - [Model Deployment](01-foundations/basics/deployment.md)
