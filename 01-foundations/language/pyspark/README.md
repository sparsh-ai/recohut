...
> 🔬 Lab: [Calculating Spark Partitions](https://nbviewer.org/github/sparsh-ai/bootcamp/blob/main/01-foundations/language/spark/lab-calculating-partitions.ipynb)
